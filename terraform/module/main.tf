locals {
  ...
  subscription_file_content = templatefile("${path.module}/templates/operator_group.yaml.tmpl", {
    NAMESPACE = var.turbo_project
  } )

  nginx_ingress_file_content = templatefile("${path.module}/templates/operator_group.yaml.tmpl", {
