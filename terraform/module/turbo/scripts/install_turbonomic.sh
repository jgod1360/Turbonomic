...
echo "Deploying Turbonomic Operator ..."
...
kubectl apply -f https://raw.githubusercontent.com/turbonomic/t8c-install/master/operator/deploy/crds/charts_v1alpha1_xl_cr.yaml -n "${TURBO_PROJECT}"
echo
